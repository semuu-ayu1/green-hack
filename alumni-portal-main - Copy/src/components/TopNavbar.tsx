...
export default function TopNavbar({ user, unreadCount, isAdmin, latestPostTime, logoUrl }: Props) {
  ...
  const navItems = [
    ...
    { label: 'GBPIET Ecosystem', icon: Users, href: '/directory?role=CAMPUS' },
    ...
    { label: 'GBPIET Feed', icon: Bell, href: '/feed' },
  ];
      ...
      <div className={styles.container}>
        ...
        <div className={styles.left}>
          <Link href="/" className={styles.logo}>
            <img src={logoUrl || "/btkit-logo.png"} alt="GBPIET" className={styles.kecLogo} />
            <span className={styles.brandName}>GBPIET <span className={styles.brandDot}>network</span></span>
          </Link>
          <div className={styles.searchWrapper}>
            <Search className={styles.searchIcon} size={18} />
            <input type="text" placeholder="Search gbpiet network..." className={styles.searchInput} />
          </div>
        </div>
